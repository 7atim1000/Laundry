    ...
    return (
        ...
        <div className='bg-white py-1 px-5 rounded-lg w-[50%] shadow-lg/30 border-b-3 border-[#0ea5e9]'>
            <div className='flex items-start justify-between'>
                ...
                <button className={` ${title === 'Completed Earning' ? 'bg-green-600 text-sm rounded-full text-white' : 'rounded-full bg-[#F6B100] text-sm'} p-3 text-sky-400 text-lg mt-2 shadow-lg/30`}>{icon}</button>
            </div>
