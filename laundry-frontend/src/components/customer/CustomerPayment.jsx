...
import PaymentInvoice from './PaymentInvocie';
    ...
    return (
        ...
        <div className='fixed inset-0 bg-opacity-50 flex items-center justify-center shadow-lg/10 z-50' style={{ backgroundColor: 'rgba(6, 76, 133, 0.4)' }} >
            <motion.div
                ...
                className='bg-white rounded-sm rounded-sm border-b-3 border-[#0ea5e9]  p-2 shadow-xl w-120 md:mt-1 mt-1 h-[calc(100vh-2rem)] overflow-y-scroll scrollbar-hidden'
            >
                ...
                <div className="flex justify-between items-center mb-4 shadow-xl p-2 ">
                    <div className='flex flex-col gap-2'>
                        ...
                        <p className ={`${customerData.balance === 0 ? "text-green-600" : "text-[#be3e3f]"} text-xs font-medium`}> 
                            <span className='text-black font-normal text-sm'>He Has Debt Of : </span> {customerData.balance.toFixed(2)}
                            <span className='text-xs font-normal text-[#1a1a1a]'> AED</span></p>
                    </div>
                    <button onClick={handleClose} className='rounded-sm text-[#be3e3f] hover:bg-[#be3e3f]/30 cursor-pointer border-b border-[#be3e3f]'>
                ...
                <form className='mt-5 space-y-6'>
                    ...
                    <div className ='flex items-center justify-between'>
                        ...
                        <div className='flex w-[80%] items-center p-3 bg-sky-50 shadow-xl'>
                            <input
                                type='date'
                                name='date'
                                value={formData.date}
