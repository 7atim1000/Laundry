    ...
    return(
        <div
            ...
            <motion.div
                ...
                className='bg-white border-b-3 rounded-sm border-[#0ea5e9]  p-2 shadow-xl w-120 md:mt-1 mt-1 h-[calc(100vh-2rem)] overflow-y-scroll scrollbar-hidden'
            >
                ...
                <form className='mt-3 space-y-6' onSubmit={handleSubmit}>
                    ...
                    <div className='flex items-center justify-between'>
                        ...
                        <div className='w-[80%] flex items-center p-3 bg-white shadow-xl rounded-sm'>
                            <select required 
                                className='w-full bg-sky-100 p-1 h-8 rounded-lg  text-xs text-[#1a1a1a] font-normal' value={formData.type} onChange={handleInputChange} name='type' >
                                <option ></option>
                    ...
                    <div className='flex items-center justify-between'>
                        ...
                        <div className='w-[80%] flex items-center p-3 bg-white shadow-xl rounded-sm'>
                            <select required 
                                className='w-full p-1 bg-sky-100 h-8 rounded-lg  text-xs text-[#1a1a1a] font-normal' value={selectedValue} onChange={handleInputChange} name='category' >
