...
const Transactions = () => {
    const Button = [
        { label: 'New Transaction', icon: <IoIosAddCircle className='text-[#0ea5e9] w-6 h-6' />, action: 'transaction' }
    ];
            ...
            <div className ='flex-[3] bg-white h-[100vh] overflow-y-scroll scrollbar-hidden '>
                ...
                <div className="flex gap-2 items-center px-15 py-2 shadow-xl bg-white text-[#1a1a1a]">
                    <input
                        type="text"
                        placeholder="Search..."
                        className="text-[#1a1a1a] border border-[#0ea5e9] p-1 rounded-lg w-full text-xs font-semibold"
                        // max-w-md
                        value={search}
                    ...
                    <select
                        className="border  border-[#0ea5e9] p-1 rounded-lg text-[#1a1a1a] text-xs font-semibold cursor-pointer"
                        value={sort}
            ...
            <div className ='flex-[1] bg-white px-2 py-3'>
                <div className="flex gap-2 items-center px-15 py-2 shadow-xl text-white">
                    <select id='frequency' value={frequency} onChange={(e) => setFrequency(e.target.value)}
                        className='border border-[#0ea5e9] rounded-md px-2 py-1 text-xs text-[#1f1f1f] '>
